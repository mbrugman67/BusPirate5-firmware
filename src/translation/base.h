...
enum T_translations{
    ...
    T_UART_SIDECHAN_TRG_MENU,
    T_UART_SIDECHAN_TRG_MENU_1,
    T_UART_SIDECHAN_TRG_MENU_PROMPT,
    T_UART_SIDECHAN_LEN_MENU,
    T_UART_SIDECHAN_LEN_MENU_1,
    T_UART_SIDECHAN_LEN_MENU_PROMPT,
    T_UART_SIDECHAN_SETUP_ERR,
