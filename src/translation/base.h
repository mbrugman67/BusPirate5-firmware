...
enum T_translations{
    ...
    T_HELP_GCMD_P,
    T_HELP_GCMD_DUMP_BYTES,
    T_HELP_GCMD_DUMP_FILE,
    T_HELP_GCMD_HEX_FILE,
    T_HELP_GCMD_FREQ_PIN,
    T_HELP_GCMD_ADC_PIN,
    T_HELP_GCMD_AUXIO_PIN,
    T_HELP_GCMD_JEP106_BANK,
    T_HELP_GCMD_JEP106_ID,
    T_HELP_GCMD_CONVERT_INVERSE_VALUE,
    T_HELP_GCMD_SCRIPT_FILE,
    T_HELP_GCMD_IMAGE_FILE,
    T_HELP_GCMD_DISK_CAT_FILE,
    T_HELP_GCMD_DISK_MKDIR_DIR,
    T_HELP_GCMD_DISK_CD_DIR,
    T_HELP_GCMD_DISK_RM_PATH,
    T_HELP_GCMD_DISK_LS_DIR,
    T_HELP_GCMD_DISK_LABEL_NAME,
    T_HELP_GCMD_MACRO_ID,
    T_HELP_GCMD_BUG_ID,
    T_HELP_GCMD_BUG_ALL_PINS,
    T_HELP_GCMD_SMPS_VOLTAGE,
    T_HELP_IRTX_PACKET,
    T_HELP_HELP,
    T_HELP_SYS_COMMAND,
    T_HELP_SYS_DISPLAY,
    ...
    T_HELP_CMD_SCRIPT,
    T_HELP_CMD_SCRIPT_PAUSE,
    T_HELP_CMD_SCRIPT_HIDE_COMMENTS,
    T_HELP_CMD_SCRIPT_ERROR_EXIT,
    T_HELP_CMD_BUTTON,
    T_HELP_CMD_MACRO,
    T_HELP_CMD_MACRO_FILES,
    T_HELP_CMD_MACRO_LOAD,
    T_HELP_CMD_MACRO_LIST,
    T_HELP_CMD_TUTORIAL,
