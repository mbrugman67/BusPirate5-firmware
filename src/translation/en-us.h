...
static char const * const en_us[]={
	...
	[T_UART_GLITCH_TRG_MENU]="Glitch trigger character",
    ...
    [T_UART_GLITCH_CNT_MENU]="Number of glitch attempts",
    [T_UART_GLITCH_CNT_MENU_1]="1 - 10000",
    [T_UART_GLITCH_CNT_PROMPT]="Number of glitch attempts before quitting (100)",
    [T_UART_GLITCH_NORDY_MENU]="Bypass 'READY' input checking",
    [T_UART_GLITCH_NORDY_MENU_1]="0, 1",
    [T_UART_GLITCH_NORDY_PROMPT]="0 to disable, 1 to enable (1, do not check input)",
    [T_UART_GLITCH_NORDY_DISABLED]="Bypass disabled ('READY' check enforced)",
    [T_UART_GLITCH_NORDY_ENABLED]="Bypass enabled ('READY' check disabled)",
	...
	[T_HELP_CMD_IMAGE_DRAW]="Draw the image on the LCD",
	...
	[T_HELP_FLASH_WRITE]="Write file to flash chip",
	[T_HELP_FLASH_READ]="Read flash chip to file",
	[T_HELP_FLASH_VERIFY]="Verify flash chip against file",
	...
	[T_HELP_1WIRE_EEPROM]="read, write and erase 243X series 1-Wire EEPROM chips",
	[T_HELP_EEPROM_DUMP]="Show contents. Space to continue, x to exit",
	[T_HELP_EEPROM_ERASE]="Erase chip",
	[T_HELP_EEPROM_WRITE]="Write file to chip",
	[T_HELP_EEPROM_READ]="Read chip to file",
	[T_HELP_EEPROM_VERIFY]="Verify chip against file",
	[T_HELP_EEPROM_TEST]="Erase and write chip with dummy data, verify",
	[T_HELP_EEPROM_LIST]="List supported EEPROM devices",
	[T_HELP_EEPROM_DEVICE_FLAG]="Specify the EEPROM device",
	[T_HELP_EEPROM_FILE_FLAG]="File to write, read or verify",
	[T_HELP_EEPROM_VERIFY_FLAG]="Verify after write, read or erase",
	[T_HELP_EEPROM_START_FLAG]="Dump: start address",
	[T_HELP_EEPROM_BYTES_FLAG]="Dump: number of bytes",
	...
	[T_HELP_SLE4442_PROTECT]="Write 32 bit protection memory (requires unlock)",
	...
	[T_HELP_SLE4442_FILE_FLAG]="Save dump to <file name>",
	...
	[T_HELP_GCMD_DUMP_BYTES]="Number of bytes to read",
	[T_HELP_GCMD_DUMP_FILE]="Output file path",
	[T_HELP_GCMD_HEX_FILE]="File to display in HEX format",
	[T_HELP_GCMD_FREQ_PIN]="IO pin for frequency measurement",
	[T_HELP_GCMD_ADC_PIN]="IO pin to measure voltage",
	[T_HELP_GCMD_AUXIO_PIN]="IO pin number",
	[T_HELP_GCMD_JEP106_BANK]="JEP106 continuation code (bank number)",
	[T_HELP_GCMD_JEP106_ID]="JEP106 vendor identification code",
	[T_HELP_GCMD_CONVERT_INVERSE_VALUE]="Value to invert",
	[T_HELP_GCMD_SCRIPT_FILE]="Script file to execute (.scr)",
	[T_HELP_GCMD_IMAGE_FILE]="Bitmap image file to display",
	[T_HELP_GCMD_DISK_CAT_FILE]="File to print",
	[T_HELP_GCMD_DISK_MKDIR_DIR]="Directory name to create",
	[T_HELP_GCMD_DISK_CD_DIR]="Directory to change to",
	[T_HELP_GCMD_DISK_RM_PATH]="File or directory to remove",
	[T_HELP_GCMD_DISK_LS_DIR]="Directory to list",
	[T_HELP_GCMD_DISK_LABEL_NAME]="Volume label name",
	[T_HELP_GCMD_MACRO_ID]="Macro number to execute",
	[T_HELP_GCMD_BUG_ID]="Bug/errata identifier to test",
	[T_HELP_GCMD_BUG_ALL_PINS]="Test all IOs for E9",
	[T_HELP_GCMD_SMPS_VOLTAGE]="Target output voltage",
	[T_HELP_IRTX_PACKET]="IR packet data in aIR format",	
    ...
    [T_HELP_DISK_HEX_ADDR]="Disable address offset",
    [T_HELP_DISK_HEX_ASCII]="Disable ASCII dump",
    [T_HELP_DISK_HEX_SIZE]="Set line size in bytes",
    [T_HELP_DISK_HEX_OFF]="Set file read start offset in bytes",
    [T_HELP_DISK_HEX_PAGER_OFF]="Dump: disable pager",
	[T_HELP_DISK_HEX_QUIET]="Dump: quiet mode, disable address and ASCII columns",
	...
	[T_HELP_DISK_LS_LONG]="Use a long listing format (size, date, time)",
	[T_HELP_DISK_LS_ALL]="Include hidden/system files",
	...
	[T_HELP_I2C_SHT3X]="Read temperature and humidity from SHT3x sensors",
	[T_HELP_I2C_SHT4X]="Read temperature and humidity from SHT4x sensors",
	[T_HELP_I2C_TCS34725_GAIN]="Set TCS34725 gain (1x, 4x, 16x, 60x)",
	[T_HELP_I2C_TCS34725_INTEGRATION]="Set TCS34725 integration time (2.4ms to 700ms)",
    ...
    [T_HELP_UART_GLITCH_EXIT]="UART Glitcher.  Press Bus Pirate button to exit.",
    [T_HELP_SECTION_SCRIPT]="run scripts, macros and assign button functions",
    [T_HELP_CMD_SCRIPT]="Run script files, automation",
	[T_HELP_CMD_SCRIPT_PAUSE]="Pause after each line for manual <enter> key",
	[T_HELP_CMD_SCRIPT_HIDE_COMMENTS]="Hide comment lines starting with #",
	[T_HELP_CMD_SCRIPT_ERROR_EXIT]="Exit script on error",
    [T_HELP_CMD_BUTTON]="Assign button functions",
    [T_HELP_CMD_MACRO]="Run macros, load a macro file",
	[T_HELP_CMD_MACRO_FILES]="List all macro files on storage",
	[T_HELP_CMD_MACRO_LOAD]="Macro file to load",	
	[T_HELP_CMD_MACRO_LIST]="List all macros in active macro file",
	...
	[T_HELP_CMD_SMPS_SETPOINTS]="Show calculated ADC setpoints",
	...
	[T_HELP_DDR5_FILE_FLAG]="File flag. Specify a file to write, read, verify or check CRC",
	[T_HELP_DDR5_BLOCK_FLAG]="Block flag. Specify a DDR5 SPD NVM block to lock or unlock (0 - 15)",
	[T_HELP_DDR4]="read, write and probe DDR4 SPD chips",
	[T_HELP_DDR4_PROBE]="Show DDR4 SPD info",
	[T_HELP_DDR4_DUMP]="Display DDR4 SPD contents",
	...
	[T_HELP_DDR4_FILE_FLAG]="File flag. Specify a file to write, read, verify or check CRC",
	[T_HELP_DDR4_BLOCK_FLAG]="Block flag. Specify a DDR4 SPD NVM block to lock (0 - 3)",	
	...
	[T_HELP_LIFE]="Conway's Game of Life cellular automaton",
	[T_HELP_SNAKE]="Snake arcade game",
	[T_HELP_2048]="2048 sliding tile puzzle",
	[T_HELP_TTT]="Tic-Tac-Toe vs minimax CPU",
	[T_HELP_HANGMAN]="Hangman word guessing game",
	[T_HELP_MINES]="Mine Sweep grid game",
	[T_HELP_BRICKS]="Bricks paddle and ball game",
	[T_HELP_DROP4]="Drop Four disc-drop game",
	[T_HELP_FLEET]="Fleet naval guessing game",
	[T_HELP_WORM]="BSD Worm snake variant game",
	[T_HELP_PCBRUN]="PCB Run side-scrolling jump game",
	[T_HELP_INVADERS]="Protocol Invaders arcade shooter",
	[T_HELP_SIGRIDE]="Signal Rider oscilloscope surfing game",
	[T_HELP_STKOVER]="Stack Overflow vertical jump platformer",
	[T_HELP_CROSSFLASH]="Crossflash data bus crossing game",
	[T_HELP_CRYPTOCRACK]="Crypto Crack timed cipher speed drill",
