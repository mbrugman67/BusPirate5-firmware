...
static char const * const en_us[]={
    ...
    [T_UART_GLITCH_FAIL_PROMPT]="ASCII value of first char of normal response (35 - '#')",
    ...
    [T_UART_GLITCH_NORDY_PROMPT]="0 to disable, 1 to enable (1)",
    ...
    [T_UART_SIDECHAN_TRG_MENU]="Side channel scan trigger character",
    [T_UART_SIDECHAN_TRG_MENU_1]="1 - 255",
    [T_UART_SIDECHAN_TRG_MENU_PROMPT]="ASCII value of trigger character (13)",
    [T_UART_SIDECHAN_LEN_MENU]="Maximum password length",
    [T_UART_SIDECHAN_LEN_MENU_1]="1 - 40",
    [T_UART_SIDECHAN_LEN_MENU_PROMPT]="Max number of password chars to work with (8)",
	[T_UART_SIDECHAN_SETUP_ERR]="Error setting up side channel scanner - check usidechn.bp file",
    ...
    [T_HELP_UART_SIDECHAN]="UART Side channel scanner.  Press Bus Pirate button to exit.",
    ...
    [T_HELP_SIDECHAN_GLITCH]="UART side channel timing scanner",
