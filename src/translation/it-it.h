...
static char const * const it_it[T_LAST_ITEM_ALWAYS_AT_THE_END]={
    [ T_ON                             ] = NULL,
    [ T_OFF                            ] = NULL,
    [ T_GND                            ] = NULL,
    [ T_INPUT                          ] = NULL,
    ...
    [ T_HW3WIRE_SPEED_MENU_1           ] = "1 a 3900kHz",
    ...
    [ T_HWLED_DEVICE_MENU_3            ] = "LED onboard (18 SK6812s)",
    ...
    [ T_HELP_NUVO51_CFG                ] = NULL,
    [ T_NUVO51_READ_CFG                ] = NULL,
    [ T_NUVO51_WRITE_CFG                ] = NULL,
    [ T_NUVO51_ERASE_CFG               ] = NULL,
    [ T_NUVO51_VERIFY_CFG              ] = NULL,
    ...
    [ T_HELP_GCMD_DUMP_BYTES           ] = NULL,
    [ T_HELP_GCMD_DUMP_FILE            ] = NULL,
    [ T_HELP_GCMD_HEX_FILE             ] = NULL,
    [ T_HELP_GCMD_FREQ_PIN             ] = NULL,
    [ T_HELP_GCMD_ADC_PIN              ] = NULL,
    [ T_HELP_GCMD_AUXIO_PIN            ] = NULL,
    [ T_HELP_GCMD_JEP106_BANK          ] = NULL,
    [ T_HELP_GCMD_JEP106_ID            ] = NULL,
    [ T_HELP_GCMD_CONVERT_INVERSE_VALUE ] = NULL,
    [ T_HELP_GCMD_SCRIPT_FILE          ] = NULL,
    [ T_HELP_GCMD_IMAGE_FILE           ] = NULL,
    [ T_HELP_GCMD_DISK_CAT_FILE        ] = NULL,
    [ T_HELP_GCMD_DISK_MKDIR_DIR       ] = NULL,
    [ T_HELP_GCMD_DISK_CD_DIR          ] = NULL,
    [ T_HELP_GCMD_DISK_RM_PATH         ] = NULL,
    [ T_HELP_GCMD_DISK_LS_DIR          ] = NULL,
    [ T_HELP_GCMD_DISK_LABEL_NAME      ] = NULL,
    [ T_HELP_GCMD_MACRO_ID             ] = NULL,
    [ T_HELP_GCMD_BUG_ID               ] = NULL,
    [ T_HELP_GCMD_BUG_ALL_PINS         ] = NULL,
    [ T_HELP_GCMD_SMPS_VOLTAGE         ] = NULL,
    [ T_HELP_IRTX_PACKET               ] = NULL,
    ...
    [ T_HELP_DISK_LS_LONG              ] = NULL,
    [ T_HELP_DISK_LS_ALL               ] = NULL,
    ...
    [ T_HELP_CMD_SCRIPT_PAUSE          ] = NULL,
    [ T_HELP_CMD_SCRIPT_HIDE_COMMENTS  ] = NULL,
    [ T_HELP_CMD_SCRIPT_ERROR_EXIT     ] = NULL,
    [ T_HELP_CMD_BUTTON                ] = NULL,
    [ T_HELP_CMD_MACRO                 ] = NULL,
    [ T_HELP_CMD_MACRO_FILES           ] = NULL,
    [ T_HELP_CMD_MACRO_LOAD            ] = NULL,
    [ T_HELP_CMD_MACRO_LIST            ] = NULL,
    ...
    [ T_HELP_CMD_SMPS_SETPOINTS        ] = NULL,
    ...
    [ T_HELP_WORM                      ] = NULL,
    [ T_HELP_PCBRUN                    ] = NULL,
    [ T_HELP_INVADERS                  ] = NULL,
    [ T_HELP_SIGRIDE                   ] = NULL,
    [ T_HELP_STKOVER                   ] = NULL,
    [ T_HELP_CROSSFLASH                ] = NULL,
    [ T_HELP_CRYPTOCRACK               ] = NULL,
